...
def display_final(isTop=False):
    ...
    if not isTop:
        ...
        if height >2200 and velocity >100:
            final3 ="You have escaped the moon’s gravity. No landing today!"
            final4 ="Game over."
...
while running:
    ...
    if height >=2200 and velocity >=100:
        ...
        instruct1 ="Land softtly without running out of fuel."
        ...
        inst2_surf = inst2_font.render(instruct1, 1, (255, 255, 255))
